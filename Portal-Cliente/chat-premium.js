...
async function sendMessage(file = null, fileName = null) {
    ...
    typingDiv.innerHTML = `<div class="bubble-content">Sira está analizando...</div>`;
    ...
    try {
        ...
        if (data.output) {
            ...
            addMessage("He recibido tu archivo. Dame un momento para procesar la información.", 'assistant');
        }
    } catch (error) {
